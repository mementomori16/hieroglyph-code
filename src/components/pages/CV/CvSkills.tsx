...
const technologyIcons: Record<string, React.ComponentType<{ size?: number; color?: string }>> = {
  // --- Merged and Reorganized Icon Definitions ---
  ...
  'Divi': (props) => <SiWordpress {...props} color="#21759B" />,
  'SMUI': (props) => <SiWordpress {...props} color="#21759B" />,
};
...
const skillCategories = [
    ...
    },
    {
        ...
        skills: ['Node.js', 'Express.js', 'Vite', 'Jest', 'Postman', 'PHP', 'Golang'],
    },
    {
    ...
    },
    {
        ...
        skills: ['Git', 'VS Code', 'Trello', 'Slack', 'Docker', 'Heroku', 'GitLab', 'Stripe', 'BunnyNet', 'EmailJS', 'DNS', 'SSL', 'SEO', 'Google Analytics'],
    },
    {
